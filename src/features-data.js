export const FEATURES = [
  ...
  { name: 'Plan Before You Build', desc: 'Think through architecture and write a concrete plan before touching code.' },
  { name: 'Background Agents', desc: 'Delegate independent work to subagents that run in parallel while you keep working.' },
  { name: 'Skills', desc: 'Load focused instruction packages for specific workflows. Works with existing skill ecosystems.' },
  { name: "You're in Control", desc: 'Approve, deny, or auto-allow each tool call. Furnace asks before doing anything risky.' },
  { name: 'Sessions That Persist', desc: 'Every conversation is saved locally. Resume, review, or branch from any past session.' },
]
